...
export default function PublicCatalog({ librarySlug }: PublicCatalogProps) {
  ...
  return (
    <main className="relative min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(246,188,96,0.18),_transparent_28%),linear-gradient(180deg,_rgba(255,253,248,0.7)_0%,_rgba(255,255,255,0.8)_48%,_rgba(246,248,251,0.7)_100%)]">
