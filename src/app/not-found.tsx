            ...
            >
              <div className="bg-primary-50 dark:bg-primary-900/20 rounded-lg p-3 md:p-4 mb-3 md:mb-4">
                <p className="text-xs sm:text-sm text-primary-700 dark:text-primary-300 italic">
                  &ldquo;The best way to find a missing page is to start looking in the right section.&rdquo; 
                  <br />
            ...
            >
              <p className="text-xs text-gray-500 dark:text-gray-400">
                ...
                <span className="text-primary-600 dark:text-primary-400">
                  📖 &ldquo;Every book has its place, but this page seems to have found a new home!&rdquo;
                </span>
              </p>
            </motion.div>
          </CardBody>
